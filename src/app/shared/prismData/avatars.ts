...
`<div class="demo-avatar-group">
    ...
    <div class="main-img-user avatar-lg">
        <img alt="avatar" class="rounded-circle" src="./assets/img/faces/6.jpg">
    </div>
    <div class="main-img-user avatar-xl d-none d-sm-block">
        <img alt="avatar" class="rounded-circle" src="./assets/img/faces/7.jpg">
    </div>
...
`<div class="demo-avatar-group">
    ...
    <div class="main-img-user avatar-md">
        <img alt="avatar" class="square" src="./assets/img/faces/5.jpg">
    </div>
    <div class="main-img-user avatar-md">
        <img alt="avatar" class="radius" src="./assets/img/faces/6.jpg">
    </div>
</div>`
...
`<div class="demo-avatar-group">
    <div class="main-avatar avatar online">
        <img alt="avatar" class="rounded-circle avatar" src="./assets/img/faces/9.jpg">
    </div>
